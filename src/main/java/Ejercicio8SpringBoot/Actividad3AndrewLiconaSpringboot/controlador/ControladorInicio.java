...
import Ejercicio8SpringBoot.Actividad3AndrewLiconaSpringboot.servicio.IUsuarioservicio;
...
public class ControladorInicio {
   ...
   { if (errores.hasErrors()) { return "modificar"; } userServicio.guardar(usuario); 
   return "redirect:/"; }
